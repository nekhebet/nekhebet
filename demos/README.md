...
<table class="mobile-table">
  ...
  <tr>
    <td colspan="2" class="mobile-side">
      **Live демо**: 0808.us.nekhebet.su:8080
    </td>
  </tr>
</table>
...
**Медиа из выбранных источников Telegram**
   - Фото, GIF, видео (клик по видео = включить/выключить звук)
...
[▶] NEXT
```
- Ручной переход к следующему медиа-слайду
- Свайп на мобильных
...
- **Нажатие на облако слов** = включить/выключить анимацию облака
- **Клик по видео** = включить/выключить звук
