Ниже — **единый, собранный и очищенный README**, без дублирования, без маркетинга, с акцентом на архитектуру, инварианты и реальные сценарии.
Я убрал лишнюю «витрину», оставил сильные формулировки из первого текста и конкретику/структуру из второго.

---

# Nekhebet — Tamper-Evident Signed Event Platform

**Nekhebet** — это инфраструктурное ядро для создания, подписи, верификации и хранения *криптографически защищённых событий* в виде неизменяемых подписанных конвертов (**SignedEnvelope**).
...
Nekhebet не является прикладным продуктом.
Это **базовый инженерный слой**, предназначенный для встраивания в другие системы.
...
## Charon Vessel (внешний компонент)
...
**Nekhebet** — это не продукт, а **инженерный фундамент** для систем, где критичны:
...
Подходит как для прямого использования, так и как основа для специализированных доменных решений.

---

Если хочешь, следующим шагом могу:

* сделать **ещё более “OSS-аскетичную” версию** (короче, суше),
* или подготовить **ARCHITECTURE.md / SECURITY.md** под аудит,
* или жёстко пройтись и сказать, где README всё ещё «слишком много обещает» по отношению к коду.
